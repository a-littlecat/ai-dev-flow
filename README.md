...
- v0.6.0 Unreleased 设计级指南：Intake、Loop Engineering、Review-Repair Loop、角色边界、Project Constitution、Memory、GitHub Issues 可选后端和 Harness 兼容说明。
...
这些能力是文档、模板、提示词和路线图，不表示当前版本具备自动脚本、自动 GitHub 同步、自动多 agent 调度、自动合并或自动发布。
