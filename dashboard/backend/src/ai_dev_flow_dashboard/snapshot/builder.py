...
class SnapshotBuilder:
    def __init__(
        ...
        *,
        ...
        self.core = core or DashboardCore(self.project_root)
    ...
    def _fresh_snapshot(
        ...
        return _finalize(snapshot, schema_path=self.schema_path)
...
def _finalize(
    ...
    *,
    ...
    validate_contract(snapshot, schema_path=schema_path)
