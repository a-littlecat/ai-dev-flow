...
> - 快照日期：2026-07-12
> - 当前模式：`CONTRACT-004` facade/CLI GREEN，等待独立 Review
> - 当前阶段：20 tests 与三条 CLI smoke 通过；Review 与 UA4 前不启动 Writer
...
| CONTRACT-004 | 实现只读 workflow_lint | C | Review | 高 | 高 | CONTRACT-003 Accepted `95ec566` | 待独立审查 | UA4 未进入 | Single / 独立分支 `codex/contract-004-workflow-lint` | [CONTRACT-004](tasks/CONTRACT-004-workflow-lint-cli.md) |
