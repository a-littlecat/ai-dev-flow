...
| DASHBOARD-BE-002 | 实现 Git 快照、本地只读 API 与实时更新 | D | In Progress | 高 | 高 | BE-001 Accepted/Committed/Review/UA | Pending | UA3 Pending | `codex/dashboard-be-002` / Uncommitted / Unmerged | [DASHBOARD-BE-002](tasks/DASHBOARD-BE-002.md) |
