...
| DASHBOARD-INTEGRATE-001 | 集成本地任务仪表盘并完成回归验收 | D | Review | 高 | 高 | FE-001 repairs 001/002 Accepted/Committed/Merged | Passed / ER-7 P0-P3=`0/0/0/0` | UA6 Pending | `codex/dashboard-integrate-001` / baseline refresh / Unmerged / Not Delivered | [DASHBOARD-INTEGRATE-001](tasks/DASHBOARD-INTEGRATE-001.md) |
