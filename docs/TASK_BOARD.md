...
| CONTRACT-004 | 实现只读 workflow_lint | C | Needs Fix | 高 | 高 | CONTRACT-003 Accepted `95ec566` | 第 1 轮复审仍有 2 项 P1；进入最终修复轮 | UA4 未进入 | Single / 独立分支 `codex/contract-004-workflow-lint` | [CONTRACT-004](tasks/CONTRACT-004-workflow-lint-cli.md) |
