...
| CONTRACT-006 | 增加 TASK_BOARD 只读投影与 drift 检查 | C | Needs Fix | 中 | 高 | CONTRACT-004 `7f0f7e5`、005 `61d0911` Accepted | 首轮复审 5 项 P1；进入修复 | UA6 未进入 | Single / Worktree `ai-dev-flow-contract-006` | [CONTRACT-006](tasks/CONTRACT-006-task-board-projection.md) |
