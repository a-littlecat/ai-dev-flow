...
> - 快照日期：2026-07-12
> - 当前模式：`CONTRACT-003` Reader GREEN，等待独立 Review
> - 当前阶段：8 个 Reader 测试通过、fixture 未改；审查和 UA3 前不启动 CLI
...
| CONTRACT-003 | 实现 Legacy / v0.7 只读 Reader | C | Review | 高 | 高 | CONTRACT-002 Accepted `f7d870d` | 待独立审查 | UA3 待证据确认 | Single / 独立分支 `codex/contract-003-readonly-readers` | [CONTRACT-003](tasks/CONTRACT-003-readonly-contract-readers.md) |
