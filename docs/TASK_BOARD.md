...
| DASHBOARD-BE-001-REPAIR-001 | 修复核心快照性能与 dirty ownership 合同 | D | Review | 高 | 高 | BE-001 Accepted/Merged；Campaign ER-1 候选 | Pending | UA3 Pending | `codex/dashboard-be-001-repair-001` / Uncommitted / Unmerged | [DASHBOARD-BE-001-REPAIR-001](tasks/DASHBOARD-BE-001-REPAIR-001.md) |
