...
> - 快照日期：2026-07-12
> - 当前模式：`CONTRACT-003` 第 2 轮有限修复
> - 当前阶段：第 1 轮复审仍有 3 项 P1；本轮达到 repair 上限
...
| CONTRACT-003 | 实现 Legacy / v0.7 只读 Reader | C | Needs Fix | 高 | 高 | CONTRACT-002 Accepted `f7d870d` | 第 1 轮复审仍有 3 项 P1 | UA3 未进入 | Single / 独立分支 `codex/contract-003-readonly-readers` | [CONTRACT-003](tasks/CONTRACT-003-readonly-contract-readers.md) |
