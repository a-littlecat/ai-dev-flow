...
| CONTRACT-005 | 启用 Compact Template 与最小 Writer 路由 | D | Review | 中 | 高 | CONTRACT-004 Accepted `7f0f7e5` | 实现与验证完成，待独立审查 | UA6 未进入 | Single / Worktree `ai-dev-flow-contract-005` | [CONTRACT-005](tasks/CONTRACT-005-compact-template-writer-routing.md) |
