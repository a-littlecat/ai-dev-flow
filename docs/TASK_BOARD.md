...
| DASHBOARD-FE-001 | 实现关系图优先的本地任务仪表盘前端 | C | In Progress | 高 | 中 | DASHBOARD-BE-001 Accepted/Committed/Review/UA | Pending / implementation checkpoint | UA4 Pending / None | Worktree `codex/dashboard-fe-001` / base `fc34f11` / Uncommitted / Unmerged / Not Closed | [DASHBOARD-FE-001](tasks/DASHBOARD-FE-001.md) |
