...
| CONTRACT-004 | 实现只读 workflow_lint | C | Review | 高 | 高 | CONTRACT-003 Accepted `95ec566` | 第 1 轮修复完成，待复审 | UA4 未进入 | Single / 独立分支 `codex/contract-004-workflow-lint` | [CONTRACT-004](tasks/CONTRACT-004-workflow-lint-cli.md) |
