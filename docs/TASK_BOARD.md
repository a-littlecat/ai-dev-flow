...
| DASHBOARD-FE-001 | 实现关系图优先的本地任务仪表盘前端 | C | Accepted | 高 | 中 | DASHBOARD-BE-001 Accepted/Committed/Review/UA | Passed / P0/P1/P2/P3=`0/0/4/0`；UA4-RVW-004 P1-001～004 Closed | UA4 Passed / User Confirmed | Worktree `codex/dashboard-fe-001` / base `fc34f11` / Committed / Unmerged / Merge Authorized / Not Pushed / Not Closed | [DASHBOARD-FE-001](tasks/DASHBOARD-FE-001.md) |
