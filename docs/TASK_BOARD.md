...
| DASHBOARD-INTEGRATE-001 | 集成本地任务仪表盘并完成回归验收 | D | Review | 高 | 高 | FE-001 repairs 001/002 Accepted/Committed/Merged | Pending / final baseline re-review | UA6 Passed / User Confirmed | `codex/dashboard-integrate-001` / `5131d03` + `6df6a94` Committed / Unmerged / Not Delivered | [DASHBOARD-INTEGRATE-001](tasks/DASHBOARD-INTEGRATE-001.md) |
