...
| CONTRACT-005 | 启用 Compact Template 与最小 Writer 路由 | D | Needs Fix | 中 | 高 | CONTRACT-004 Accepted `7f0f7e5` | 第 1 轮复审剩余 1 项 P1；进入最终修复 | UA6 未进入 | Single / Worktree `ai-dev-flow-contract-005` | [CONTRACT-005](tasks/CONTRACT-005-compact-template-writer-routing.md) |
