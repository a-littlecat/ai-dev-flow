...
| DASHBOARD-BE-001-REPAIR-001 | 修复核心快照性能与 dirty ownership 合同 | D | In Progress | 高 | 高 | BE-001 Accepted/Merged；修复合同冻结 | Pending | UA3 Pending | `codex/dashboard-be-001-repair-001` / Uncommitted / Unmerged | [DASHBOARD-BE-001-REPAIR-001](tasks/DASHBOARD-BE-001-REPAIR-001.md) |
